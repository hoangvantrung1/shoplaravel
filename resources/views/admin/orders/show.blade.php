...
@section('content')
    ...
    <div class="grid md:grid-cols-2 gap-8">
        <div class="bg-white p-6 rounded shadow space-y-2">
            ...
            <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST" class="mt-4">
                ...
                <button type="submit" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded ml-2">Cập
                    nhật</button>
            </form>
        </div>
    ...
    <a href="{{ route('admin.orders.index') }}"
        class="inline-block mt-6 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">Quay lại danh sách</a>
@endsection