        ...
        <section class="py-12 bg-white">
            <div class="max-w-7xl mx-auto px-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <a href="#"
                        class="bg-white rounded-xl shadow-md overflow-hidden flex flex-col hover:shadow-lg transition h-full">
                        <div class="h-48 w-full relative">
                            <video class="w-full h-full object-cover" autoplay muted loop>
                                <source src="/videos/banner.mp4" type="video/mp4">
                            </video>
                            <div
                                class="absolute bottom-0 left-0 bg-purple-600 text-white text-sm font-semibold px-3 py-1">
                        ...
                        <div class="p-6 flex-1 flex flex-col justify-between">
                            <div>
                                ...
                                <p class="text-gray-600 mb-4">Đánh giá chi tiết những tính năng mới nhất trên iPhone 16
                                    Pro Max sau 1 tháng sử dụng.</p>
                            </div>
                    ...
                    <a href="#"
                        ...
                        <div class="h-48 w-full relative">
                            ...
                            <div
                                class="absolute bottom-0 left-0 bg-green-600 text-white text-sm font-semibold px-3 py-1">
                        ...
                        <div class="p-6 flex-1 flex flex-col justify-between">
                            <div>
                                ...
                                <p class="text-gray-600 mb-4">Trải nghiệm âm thanh không gian và chống ồn chủ động cải
                                    tiến trên AirPods Pro thế hệ mới.</p>
                            </div>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-purple-600 font-semibold hover:underline">Xem chi tiết</span>
                    ...
                    <a href="#"
                        ...
                        <div class="h-48 w-full relative">
                            ...
                            <div
                                class="absolute bottom-0 left-0 bg-blue-600 text-white text-sm font-semibold px-3 py-1">
                        ...
                        <div class="p-6 flex-1 flex flex-col justify-between">
                            <div>
                                ...
                                <p class="text-gray-600 mb-4">Chuyên gia công nghệ chia sẻ về những xu hướng đáng chú ý
                                    trong năm tới.</p>
                            </div>
                            <div class="flex items-center justify-between mt-4">
                                <span class="text-purple-600 font-semibold hover:underline">Xem chi tiết</span>
